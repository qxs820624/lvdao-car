...
<html lang="en">
    ...
    <body>
    	<div class="container">
            ...
            <div class="income_detail_cons">
                <div class="total outer">
                    <p>当月收入总额：<span>¥10000</span></p>
                    <div class="date">
            ...
            layui.use('flow', function(){
                ...
                flow.load({
                    ...
                    setTimeout(function(){
                        ...
                        for(var i = 0; i < 20; i++){
                            //TODO  后台数据
                            lis.push('<li class="outer"><div class="data_time"><i>租车收入</i><p>2018/03/12 09:00:00</p></div><span>¥100</span></li>')
                        }
