...
public class JPushUtil {
	...
	public static void main(String[] args) {
		//String type = "2";
		String ALERT = "【实事帮】#平面设计# 视频";
		String userName = "3";
		Map<String, String> extras = new HashMap<String, String>();
		extras.put("receiveUserId", "4");
		extras.put("receiveUserName", "13128882064");
		extras.put("receiveMessageId", "75");
		PushPayload payload = JPushUtil.buildPushObject_all_alias_alert_extras(ALERT, userName, extras);
		System.out.println("==============="+JSONObject.toJSONString(payload));
		JPushUtil.push(payload);
	}
